<div class="bg-blue-logo shadow-lg">
    a
    {{-- <h1 class="mt-8 text-6xl font font-medium text-white text-center">
        Pizza Coding
    </h1>

    <section class="mt-8 text-2xl font-medium text-white text-center">
        <p>
