<div>
    <div class="flex sm:justify-center">
        ...
        {{-- TODO Agregar funcionalidad al botón de carrito --}}
        <nav x-data="{ showMenu: false, showCart: false }"
                                                            ...
                                                            <div>
                                                                <button @click="showCart = ! showCart"
                                                                    ...
                                                                    <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                                                                        width="1.5rem" viewBox="0 0 576 512">
                                                                        <style>
                                                                            svg {
                                                                                fill: #011e2d
                                                                            }
...
@else
    <div class="flex justify-start items-center">
        <div>
            <button @click="showCart = ! showCart"
                class="inline-flex items-center justify-center p-2 rounded-md text-blue-logo bg-yellow-200">
                <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" width="1.5rem" viewBox="0 0 576 512">
                    <style>
                        svg {
                            fill: #011e2d
                        }
...
{{-- TODO Componetizar el menú --}}
{{-- Menú colapsable --}}
<div :class="{ 'block': showMenu, 'hidden': !showMenu }" class="items-center justify-between hidden w-full md:hidden">
