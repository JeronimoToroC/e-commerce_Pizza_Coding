<article class="relative w-full" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        <!-- Items -->
        @foreach ($products as $product)
            <a href="/menu/{{ $product->slug }}" class="carousel-item" data-carousel-item>
                <img src="{{ asset($product->image) }}" class="d-block w-full" alt="{{ $product->name }}">
